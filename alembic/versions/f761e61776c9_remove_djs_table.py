...
def downgrade():
    ...
    op.create_table('social_pages',
                    ...
                    sa.ForeignKeyConstraint(['dj_id'], ['djs.id'], name='social_pages_dj_id_fkey'),
    ...
    op.create_table('djs_videos',
                    ...
                    sa.ForeignKeyConstraint(['dj_id'], ['djs.id'], name='djs_videos_dj_id_fkey'),
                    sa.ForeignKeyConstraint(['video_id'], ['videos.id'], name='djs_videos_video_id_fkey')
                    )
    # ### end Alembic commands ###
