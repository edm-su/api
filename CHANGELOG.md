...
- **(deps)** update dependency fastapi to v0.115.14 - ([54ef161](https://github.com/edm-su/api/commit/54ef1612e996fcb4f4342ea08483cc6a37b2b102)) - renovate[bot]
- **(deps)** update dependency fastapi to v0.115.13 - ([8d9eaa5](https://github.com/edm-su/api/commit/8d9eaa5771837600e8997ae3d59fa053fb312a60)) - renovate[bot]
- **(deps)** update dependency aioboto3 to >=14.3.0,<14.4.0 - ([465918e](https://github.com/edm-su/api/commit/465918e0b692e79b0d6f1c272b59d74432bd119c)) - renovate[bot]
- **(deps)** update dependency aioboto3 to >=14.2.0,<14.3.0 - ([1da7388](https://github.com/edm-su/api/commit/1da73884e9016e8f6e73bb8a9d47a2661ebc03cc)) - renovate[bot]
- **(deps)** update dependency aioboto3 to v14 (#680) - ([2985efb](https://github.com/edm-su/api/commit/2985efbdeb3077d8bbe4430e7d5a5a2ec4a4d9d5)) - renovate[bot]
- **(deps)** update dependency pillow to >=11.2.0,<11.3.0 - ([5ac4c12](https://github.com/edm-su/api/commit/5ac4c12832a647711029bb8d383a2aa1c20947ce)) - renovate[bot]
- **(deps)** update dependency fastapi to v0.115.12 - ([33ac292](https://github.com/edm-su/api/commit/33ac292076859da26308c615557ce9da067bbcf8)) - renovate[bot]
- **(deps)** update dependency fastapi to v0.115.11 - ([ac1749e](https://github.com/edm-su/api/commit/ac1749ed6746195389877a9ab56253c3bbed2def)) - renovate[bot]
- **(deps)** update dependency fastapi to v0.115.10 - ([46c81a8](https://github.com/edm-su/api/commit/46c81a8393fd43d54e202c1a620315c3e0b5331b)) - renovate[bot]
- **(deps)** update dependency fastapi to v0.115.9 - ([f22c35e](https://github.com/edm-su/api/commit/f22c35ea8c8cb28ce963cf23b7b7f63644e42515)) - renovate[bot]
- **(deps)** update dependency fastapi to v0.115.8 - ([10a6ae6](https://github.com/edm-su/api/commit/10a6ae619161304089f677fc26557095bec7719f)) - renovate[bot]
- **(deps)** update dependency fastapi to v0.115.7 - ([417817d](https://github.com/edm-su/api/commit/417817d9456f44b9ec520ad4b2495bcc14c0003c)) - renovate[bot]
#### Build system
- migrate build system from hatchling to uv_build (#685) - ([abb1f8a](https://github.com/edm-su/api/commit/abb1f8a54c48580ad9a2b20bd5b9d136809d3296)) - Egor Gluhih
#### Continuous Integration
- fix for simultaneous event triggering (#684) - ([2aa8747](https://github.com/edm-su/api/commit/2aa874778146bf34c2178a0f22345fad6832cad8)) - Egor Gluhih
#### Features
- add video edit (#682) - ([b393a7c](https://github.com/edm-su/api/commit/b393a7c31c8cf5a7fcd77f6022085b88f0e643bd)) - Egor Gluhih
#### Miscellaneous Chores
- **(deps)** lock file maintenance - ([0de56a4](https://github.com/edm-su/api/commit/0de56a41bd686fce608748c8d0604a3455837a37)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.12.1 - ([8ce50cf](https://github.com/edm-su/api/commit/8ce50cf874129cf1da9ea9a698e4385f73ccac21)) - renovate[bot]
- **(deps)** lock file maintenance - ([a77fb54](https://github.com/edm-su/api/commit/a77fb54c1c52ad4e2581147ddba7d226d83c057c)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.12.0 - ([6a086e4](https://github.com/edm-su/api/commit/6a086e4411fa0f5e70e5de05ea829922c30d0065)) - renovate[bot]
- **(deps)** update dependency ruff to >=0.12.0,<0.13.0 - ([1187e62](https://github.com/edm-su/api/commit/1187e62e24a1b1fde3a1726090a169ba7737ce85)) - renovate[bot]
- **(deps)** update pre-commit hook pre-commit/mirrors-mypy to v1.16.1 - ([0621384](https://github.com/edm-su/api/commit/062138440d70035089fe3ccbe007778459991c70)) - renovate[bot]
- **(deps)** lock file maintenance - ([87491b4](https://github.com/edm-su/api/commit/87491b4b9938e447edd00e6404b037dd875ec850)) - renovate[bot]
- **(deps)** update getmeili/meilisearch docker tag to v1.15.2 - ([16f1cb8](https://github.com/edm-su/api/commit/16f1cb885a89c0383f12af215e33cd23e0c55e7d)) - renovate[bot]
- **(deps)** update python docker tag to v3.13.5 - ([975d225](https://github.com/edm-su/api/commit/975d225dfbb0a8c4feb10d1bb5904e401bac68e6)) - renovate[bot]
- **(deps)** update dependency pytest-cov to >=6.2.1,<6.3.0 - ([9d2e938](https://github.com/edm-su/api/commit/9d2e938651cb3a09c03ca6f2fca4552f9f0ada09)) - renovate[bot]
- **(deps)** update dependency faker to >=37.4.0,<37.5.0 - ([5e50d84](https://github.com/edm-su/api/commit/5e50d843a44113c4585de7b367e942ea855f50a6)) - renovate[bot]
- **(deps)** update getmeili/meilisearch docker tag to v1.15.1 - ([609b1fd](https://github.com/edm-su/api/commit/609b1fd8328f565f6296cf6c3c71f08954ebfa78)) - renovate[bot]
- **(deps)** update getmeili/meilisearch docker tag to v1.15.0 - ([daebf65](https://github.com/edm-su/api/commit/daebf654b369a11e25fcce1339a2adda1409e626)) - renovate[bot]
- **(deps)** lock file maintenance - ([2423a7e](https://github.com/edm-su/api/commit/2423a7e7d638fefca94ab9eada1123c33447c8cb)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.13 - ([5d1188a](https://github.com/edm-su/api/commit/5d1188a0c66d663f93794e62896c2d2f97e2d983)) - renovate[bot]
- **(deps)** update python docker tag to v3.13.4 - ([226ec55](https://github.com/edm-su/api/commit/226ec55d3d53db481f55b3e1731b41d76ba5b2dd)) - renovate[bot]
- **(deps)** lock file maintenance - ([cbb1404](https://github.com/edm-su/api/commit/cbb1404b025a40697b2badd4a57d0435286378d1)) - renovate[bot]
- **(deps)** update pre-commit hook pre-commit/mirrors-mypy to v1.16.0 - ([e239ead](https://github.com/edm-su/api/commit/e239ead213dc0358ad95a437ee1081f15f4d6fe9)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.12 - ([cecaea9](https://github.com/edm-su/api/commit/cecaea9aea83704a073549a4024e9443b8f91612)) - renovate[bot]
- **(deps)** lock file maintenance - ([5a238b2](https://github.com/edm-su/api/commit/5a238b23992ab6d740c115d5f772f761a2a4f5c1)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.11 - ([febf868](https://github.com/edm-su/api/commit/febf8689064893f9283a6be800cbe24896a89ec0)) - renovate[bot]
- **(deps)** lock file maintenance - ([b934b19](https://github.com/edm-su/api/commit/b934b19a0ec4cb0055cf3b724cd4d95fb69d7950)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.10 - ([40ad4f4](https://github.com/edm-su/api/commit/40ad4f4bae602646849c020a47441fdd089db6fa)) - renovate[bot]
- **(deps)** update dependency faker to >=37.3.0,<37.4.0 - ([a0015be](https://github.com/edm-su/api/commit/a0015be733531310371a58cb2a9f45ffbb7fb994)) - renovate[bot]
- **(deps)** lock file maintenance - ([24eb28e](https://github.com/edm-su/api/commit/24eb28ea2edd1b4962583eb4b800009da1bdb13d)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.9 - ([2f8f921](https://github.com/edm-su/api/commit/2f8f92187bc1f9ae48c915ca28f16f0475da4202)) - renovate[bot]
- **(deps)** update postgres docker tag to v17.5 - ([f1b16ea](https://github.com/edm-su/api/commit/f1b16eaddec95552eae109b4f57026996f4dedaf)) - renovate[bot]
- **(deps)** update pre-commit hook compilerla/conventional-pre-commit to v4.2.0 - ([d6c8c0d](https://github.com/edm-su/api/commit/d6c8c0d4c1607abad1b2073775e2818cf6de0135)) - renovate[bot]
- **(deps)** lock file maintenance - ([989d889](https://github.com/edm-su/api/commit/989d889aa691a868304046de6d2b757e59316f3a)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.8 - ([93c68c4](https://github.com/edm-su/api/commit/93c68c4e27bdd152b39b672d751b32fddce38292)) - renovate[bot]
- **(deps)** update pre-commit hook compilerla/conventional-pre-commit to v4.1.0 - ([b632d3b](https://github.com/edm-su/api/commit/b632d3b4ff9be86a2e016b054c3384367a55c34a)) - renovate[bot]
- **(deps)** lock file maintenance - ([e262c7e](https://github.com/edm-su/api/commit/e262c7eaae8b8c2f0ed33c87f4b1abf45fd2e10a)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.7 - ([a3b4128](https://github.com/edm-su/api/commit/a3b412819b6d59d14467ddc44afed504ccfa3a0a)) - renovate[bot]
- **(deps)** lock file maintenance - ([49ec326](https://github.com/edm-su/api/commit/49ec3260e46c712269d9db206bd682f73642fb21)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.6 - ([16728c9](https://github.com/edm-su/api/commit/16728c94e35ef78107160ef02aef4da774299baa)) - renovate[bot]
- **(deps)** update getmeili/meilisearch docker tag to v1.14.0 - ([041889e](https://github.com/edm-su/api/commit/041889e755c0fcab6b29c8b1558af6bb3fd9fd88)) - renovate[bot]
- **(deps)** lock file maintenance - ([c7e7475](https://github.com/edm-su/api/commit/c7e7475a38993b3db606488873fd176ca7e384ee)) - renovate[bot]
- **(deps)** lock file maintenance (#679) - ([5e57572](https://github.com/edm-su/api/commit/5e5757202d24eeea3016517d84e3d724301cbcb6)) - renovate[bot]
- **(deps)** update dependency ruff to >=0.11.5,<0.12.0 (#681) - ([46c83cc](https://github.com/edm-su/api/commit/46c83cc3375ae1fe77da0abd3f971548d0a686c8)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.5 - ([b9bb8b3](https://github.com/edm-su/api/commit/b9bb8b318c2a23d04105a55718fad3538e5ddcad)) - renovate[bot]
- **(deps)** update python docker tag to v3.13.3 - ([d183b55](https://github.com/edm-su/api/commit/d183b556ae5011322db8b4259f2743e1a2997fc2)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.4 - ([09c5847](https://github.com/edm-su/api/commit/09c5847f9f4d2163d5cea4cb8a42c3a8c3036972)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.3 - ([a3f6096](https://github.com/edm-su/api/commit/a3f609618d770c5bd5242dde9382f4b13b0a1d5d)) - renovate[bot]
- **(deps)** update dependency pytest-cov to >=6.1.0,<6.2.0 - ([702cd95](https://github.com/edm-su/api/commit/702cd95c52ef9d1640844a26ca3e429be7fd0615)) - renovate[bot]
- **(deps)** update dependency faker to >=37.1.0,<37.2.0 - ([a6370b7](https://github.com/edm-su/api/commit/a6370b76db3b6e5b897bf48654d085ea71b6cf7f)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.2 - ([62a98d2](https://github.com/edm-su/api/commit/62a98d2df9f5909cfc32bcbe062553615eeb6bd9)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.1 - ([e23d5d4](https://github.com/edm-su/api/commit/e23d5d4b1cd5a04007bb9b2947d8f477f35ab443)) - renovate[bot]
- **(deps)** update dependency pre-commit to >=4.2.0,<4.3.0 - ([b5adfd8](https://github.com/edm-su/api/commit/b5adfd867b77ad3a43d36eb41c80c5d104eae91b)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.11.0 - ([76ab771](https://github.com/edm-su/api/commit/76ab771a824b3725f17b5b9d2033b2c13567d510)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.10.0 - ([524ee25](https://github.com/edm-su/api/commit/524ee25fe8f3fe61aa1b2172e3927ec3099ad94a)) - renovate[bot]
- **(deps)** update dependency faker to v37 - ([1c37f00](https://github.com/edm-su/api/commit/1c37f001b4223d30b11637a81546b681a51d18ed)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.9.10 - ([3781d83](https://github.com/edm-su/api/commit/3781d837517c65dac73089eb12268bf17315a451)) - renovate[bot]
- **(deps)** update dependency faker to >=36.2.2,<36.3.0 - ([93deec4](https://github.com/edm-su/api/commit/93deec4d2ff96f6d5c157272856a7598ac054da7)) - renovate[bot]
- **(deps)** update getmeili/meilisearch docker tag to v1.13.3 - ([05eb4bc](https://github.com/edm-su/api/commit/05eb4bcec4b42bb047db77d2fc86ef60c485a46f)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.9.9 - ([4411012](https://github.com/edm-su/api/commit/4411012e8fb9aa59a59991c181d4b723beadd2e4)) - renovate[bot]
- **(deps)** update getmeili/meilisearch docker tag to v1.13.2 - ([358c8e9](https://github.com/edm-su/api/commit/358c8e9ce43e26b007ea1d62a788a6eef4adb0c9)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.9.8 - ([7aa7d47](https://github.com/edm-su/api/commit/7aa7d47a113cc5c4ac5d4d1a04ba95f579fe3620)) - renovate[bot]
- **(deps)** update getmeili/meilisearch docker tag to v1.13.1 - ([161acb3](https://github.com/edm-su/api/commit/161acb38b129487c21270f16898333b6c1827251)) - renovate[bot]
- **(deps)** update postgres docker tag to v17.4 - ([e94db26](https://github.com/edm-su/api/commit/e94db261b727d029438afbdba54107e34507c1ec)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.9.7 - ([82c7d20](https://github.com/edm-su/api/commit/82c7d20dbcd3abdc7b3f4a353f76dbbc31356cc9)) - renovate[bot]
- **(deps)** update getmeili/meilisearch docker tag to v1.13.0 - ([c97559f](https://github.com/edm-su/api/commit/c97559f41d8b3583977ad0ea2690021d161856ee)) - renovate[bot]
- **(deps)** update postgres docker tag to v17.3 - ([821aef8](https://github.com/edm-su/api/commit/821aef81a0dd578376bb7b78e587c6fd465ba915)) - renovate[bot]
- **(deps)** update dependency faker to v36 - ([9e96db2](https://github.com/edm-su/api/commit/9e96db2444503f489dace0b9dfa772cd63a01350)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.9.6 - ([adb5cc4](https://github.com/edm-su/api/commit/adb5cc43c2e679eb4b8f18cde9381d57c985d472)) - renovate[bot]
- **(deps)** lock file maintenance - ([4cbde67](https://github.com/edm-su/api/commit/4cbde67fbaf0094154f7cc514bc9e53419e7a537)) - renovate[bot]
- **(deps)** update python docker tag to v3.13.2 - ([849018a](https://github.com/edm-su/api/commit/849018a4ecf031f217c831059ed3fbf1c9b08507)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.9.5 - ([5d38e60](https://github.com/edm-su/api/commit/5d38e602fd2d91bc4227d2875206d87b0a333b37)) - renovate[bot]
- **(deps)** update pre-commit hook pre-commit/mirrors-mypy to v1.15.0 - ([5d604b9](https://github.com/edm-su/api/commit/5d604b97d9ad5bc7fb767a4d79d26913ae926324)) - renovate[bot]
- **(deps)** lock file maintenance - ([1e194ad](https://github.com/edm-su/api/commit/1e194ad73688fca40dcd13a1d55cf3f607a24d51)) - renovate[bot]
- **(deps)** update dependency faker to >=35.2.0,<35.3.0 - ([f94bdf5](https://github.com/edm-su/api/commit/f94bdf55720bad87bc4c1abb0419c9c27797a25f)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.9.4 - ([4a1ab6e](https://github.com/edm-su/api/commit/4a1ab6e5b2ac03ac5722d8a162de2b2ef70a61ac)) - renovate[bot]
- **(deps)** update getmeili/meilisearch docker tag to v1.12.8 - ([5e69962](https://github.com/edm-su/api/commit/5e69962dfd0cd7ea3a69276072cee6809c50e710)) - renovate[bot]
- **(deps)** update dependency faker to v35 - ([b20dc97](https://github.com/edm-su/api/commit/b20dc97d100f11ea03826784d255e8044d349681)) - renovate[bot]
- **(deps)** update pre-commit hook charliermarsh/ruff-pre-commit to v0.9.3 - ([6b1f6dc](https://github.com/edm-su/api/commit/6b1f6dca4f9931fa4e20b9d4b703b8896ee78e57)) - renovate[bot]
- **(deps)** update getmeili/meilisearch docker tag to v1.12.7 - ([635d970](https://github.com/edm-su/api/commit/635d97072fe66e1ca3b6f2ec37e445cbf7d02bcd)) - renovate[bot]
