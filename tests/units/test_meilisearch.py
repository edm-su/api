...
class TestMeilisearchRepository:
    def test_normalize_index_name(self: Self) -> None:
        index_name = MeilisearchRepository.normalize_index_name("index")
    ...
    @pytest.mark.asyncio()
    async def test_close(self: Self, mocker: MockerFixture) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_clear_index(self: Self, ms_video: MeilisearchVideo) -> None:
    ...
    @pytest.mark.asyncio()
    async def test_indexes(self: Self, ms_video: MeilisearchVideo) -> None:
